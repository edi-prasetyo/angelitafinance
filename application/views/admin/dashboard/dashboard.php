              ...
              <a href="#" class="small-box-footer">
                More info <i class="fas fa-arrow-circle-right"></i>
                            ...
                            <div class="col-md-6 mt-md-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="ti-car"></i> Booking</div>
                                            <h2>3,984</h2>
                                        </div>
                            ...
                            <div class="col-md-6 mb-3 mb-lg-0">
                                <a href="<?php echo base_url('admin/pelanggan/create');?>">
                                <div class="card">
                                    <div class="seo-fact sbg3">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                        <div class="seofct-icon"><i class="ti-plus"></i> </div>
                                            <div class="seofct-icon">Tambah Pelanggan</div>
                                        </div>
                                    </div>
                                </div>
                                </a>
                            ...
                            <a href="#">
                                <div class="card">
                                    <div class="seo-fact sbg4">
                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                        <div class="seofct-icon"><i class="ti-plus"></i> </div>
                                            <div class="seofct-icon">Jadwalkan Booking</div>
                    ...
                    <!-- <div class="col-xl-8 col-lg-12 mt-5 mx-auto">
                        <div class="card">
